...
namespace Blog.Migrations
{
    ...
    [Migration("20211031192827_subscriptions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Models.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6aea4ee8-2198-493c-b3ce-86dc27c98bbc",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEC4ycQ+ZpdWRuupCwxTff1lhblAh4tgaIL6Fq0eCkH6TF++ehjx4IsAsYhJ22BqT8g==",
                        ...
                        new
                        {
                            Id = "0e1b77fc-7587-444f-a08a-77bf82694472",
                            AccessFailedCount = 10,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMlYpWcy/A9ALLPXyQ3xH7PpIKVTTGlaVtmkl2bIO1pbKTS1ZxKykZ6JopjnWftVzg==",
                            PhoneNumberConfirmed = true,
                            TwoFactorEnabled = false,
                            UserName = "Harry"
                        });
            ...
            modelBuilder.Entity("Blog.Models.Entities.BlogApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Blog.Models.Entities.Blogg", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 10, 31, 20, 28, 26, 450, DateTimeKind.Local).AddTicks(8389),
                            Modified = new DateTime(2021, 10, 31, 20, 28, 26, 455, DateTimeKind.Local).AddTicks(6666),
                            Name = "Lorem ipsum dolor",
                            OwnerId = "6aea4ee8-2198-493c-b3ce-86dc27c98bbc"
                        },
                        new
                        {
                            BlogId = 2,
                            ClosedForPosts = false,
                            Created = new DateTime(2021, 10, 31, 20, 28, 26, 455, DateTimeKind.Local).AddTicks(9157),
                            Modified = new DateTime(2021, 10, 31, 20, 28, 26, 455, DateTimeKind.Local).AddTicks(9182),
                            Name = "Quisque convallis est",
                            OwnerId = "0e1b77fc-7587-444f-a08a-77bf82694472"
                        },
                        new
                        {
                            BlogId = 3,
                            ClosedForPosts = false,
                            Created = new DateTime(2021, 10, 31, 20, 28, 26, 455, DateTimeKind.Local).AddTicks(9232),
                            Modified = new DateTime(2021, 10, 31, 20, 28, 26, 455, DateTimeKind.Local).AddTicks(9239),
                        ...
                        new
                        {
                            BlogId = 4,
                            ClosedForPosts = false,
                            Created = new DateTime(2021, 10, 31, 20, 28, 26, 455, DateTimeKind.Local).AddTicks(9280),
                            Modified = new DateTime(2021, 10, 31, 20, 28, 26, 455, DateTimeKind.Local).AddTicks(9288),
            ...
            modelBuilder.Entity("Blog.Models.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CommentId = 1,
                            Created = new DateTime(2021, 10, 31, 20, 28, 26, 456, DateTimeKind.Local).AddTicks(6184),
                        ...
                        {
                            CommentId = 2,
                            Created = new DateTime(2021, 10, 31, 20, 28, 26, 456, DateTimeKind.Local).AddTicks(7559),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PostId = 1,
                        ...
                        {
                            CommentId = 3,
                            Created = new DateTime(2021, 10, 31, 20, 28, 26, 456, DateTimeKind.Local).AddTicks(7682),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PostId = 2,
            ...
            modelBuilder.Entity("Blog.Models.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 10, 31, 20, 28, 26, 456, DateTimeKind.Local).AddTicks(1836),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NumberOfComments = 2,
                            Title = "First post"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2021, 10, 31, 20, 28, 26, 456, DateTimeKind.Local).AddTicks(7633),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NumberOfComments = 1,
                            Title = "Second post"
                        });
