...
namespace Blog.Migrations
{
    ...
    [Migration("20211013205728_not owner but create comment shows owner")]
    partial class notownerbutcreatecommentshowsowner
    {
            ...
            modelBuilder.Entity("Blog.Models.Entities.Blogg", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 10, 13, 22, 57, 27, 426, DateTimeKind.Local).AddTicks(6794),
                        ...
                        new
                        {
                            BlogId = 2,
                            ClosedForPosts = false,
                            Created = new DateTime(2021, 10, 13, 22, 57, 27, 433, DateTimeKind.Local).AddTicks(1418),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            BlogId = 3,
                            ClosedForPosts = false,
                            Created = new DateTime(2021, 10, 13, 22, 57, 27, 433, DateTimeKind.Local).AddTicks(1717),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            BlogId = 4,
                            ClosedForPosts = false,
                            Created = new DateTime(2021, 10, 13, 22, 57, 27, 433, DateTimeKind.Local).AddTicks(1780),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Blog.Models.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CommentId = 1,
                            Created = new DateTime(2021, 10, 13, 22, 57, 27, 433, DateTimeKind.Local).AddTicks(7678),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PostId = 1,
                            Text = "Is this latin?"
                        },
                        ...
                        {
                            CommentId = 2,
                            Created = new DateTime(2021, 10, 13, 22, 57, 27, 433, DateTimeKind.Local).AddTicks(8972),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PostId = 1,
                        ...
                        {
                            CommentId = 3,
                            Created = new DateTime(2021, 10, 13, 22, 57, 27, 433, DateTimeKind.Local).AddTicks(9090),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PostId = 2,
            ...
            modelBuilder.Entity("Blog.Models.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 10, 13, 22, 57, 27, 433, DateTimeKind.Local).AddTicks(4164),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NumberOfComments = 2,
                            Title = "First post"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2021, 10, 13, 22, 57, 27, 433, DateTimeKind.Local).AddTicks(9043),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NumberOfComments = 1,
                            Title = "Second post"
                        });
